...
async function query_inde(base64Image, promt, promt_fw, numrs, numts, nc) {
    
    // Gửi request và nhận kết quả trả về
    const response = await fetch(
        `https://dd5b-34-169-75-2.ngrok-free.app/i2i/edit`,
        {   
            method: "POST",
            headers: {
...
document.getElementById('edit').addEventListener('click', function() {
    ...
    base64Image.then(base64 => {
        query_inde(base64, promt, promt_fw, numrs, numts, nc)
        .then(data => {
