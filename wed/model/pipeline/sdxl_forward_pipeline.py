...
class SDXL_fwd(StableDiffusionXLImg2ImgPipeline):
    ...
    def __call__(
        ...
        edit_guidance_scale: Optional[Union[float, List[float]]] = [5.0],
...
#----------------------------------------------------------------------
                ...
                #     x = noise_pred
                noise_pred = noise_pred * 0.8 + noise_guidance_edit * 0.2
